...
#Usando dft.cpp, com filestorange.cpp como referencia. Ler arquivo Yaml.
...
#Função file:
def img_yml():
    ss_yml = f"imagens/Ex5_senoide-256.yml"

    fs = cv2.FileStorage(ss_yml, cv2.FileStorage_READ)
...
#expande a imagem de entrada para o melhor tamanho no qual a DFT pode ser executada, preenchendo com zeros a
